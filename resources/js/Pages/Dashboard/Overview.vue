    ...
    <DashboardLayout>
        ...
        <header class="flex justify-between items-center mb-8">
            ...
            <div>
                <select
                    ...
                    class="border-none shadow shadow-zinc-200 rounded text-xs focus:border-transparent focus:ring focus:ring-zinc-300 focus:ring-opacity-80"
                >
        ...
        <div class="space-y-14">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div
                    class="bg-white rounded-xl shadow shadow-zinc-200 px-3 py-5 xl:px-4 xl:py-6 flex items-center space-x-2.5 xl:space-x-4"
                >
                    <div class="bg-c-green-100 bg-opacity-50 rounded-full p-2">
                        <svg
                            ...
                            class="feather feather-package flex-none w-6 h-6 xl:w-7 xl:h-7 text-c-green-300"
                        >
                    ...
                    <div class="flex flex-col xl:space-y-1">
                        <span
                            class="text-zinc-500 text-[13px] xl:text-sm leading-tight"
                            >Orders placed</span
                        >
                        <span class="font-medium text-sm xl:text-base">{{
                            orders ? orders.orders_placed : 0
                        }}</span>
                    </div>
                </div>
                ...
                >
                    <div class="bg-c-green-100 bg-opacity-50 rounded-full p-2">
                        <svg
                            class="w-6 h-6 xl:w-7 xl:h-7 flex-none text-c-green-300"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex flex-col xl:space-y-1">
                        ...
                        >
                        <span class="font-medium text-sm xl:text-base"
                            >${{ orders ? orders.total_spent : 0 }}</span
                        >
                    </div>
                </div>
                ...
                >
                    <div class="bg-c-green-100 bg-opacity-50 rounded-full p-2">
                        <svg
                            class="w-[21px] h-[21px] xl:w-[25px] xl:h-[25px] flex-none text-c-green-300"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                            <path
                    ...
                    <div class="flex flex-col xl:space-y-1">
                        ...
                        >
                        <span class="font-medium text-sm xl:text-base"
                            >${{ orders ? orders.avg_expense : 0 }}</span
                        >
                    </div>
                </div>
                ...
                >
                    <div class="bg-c-green-100 bg-opacity-50 rounded-full p-2">
                        <svg
                            class="w-5 h-5 xl:w-[24px] xl:h-[24px] flex-none text-c-green-300"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                            <path
                    ...
                    <div class="flex flex-col xl:space-y-1">
                        ...
                        >
                        <span class="font-medium text-sm xl:text-base"
                            >${{ orders ? orders.max_expense : 0 }}</span
                        >
                    </div>
                </div>
            </div>
        ...
        <div
            class="lg:flex lg:space-x-4 lg:items-start space-y-10 lg:space-y-0 mt-8"
        >
            <section
                class="lg:w-[70%] bg-white rounded-xl shadow shadow-zinc-200 px-4 py-6"
            >
            ...
            <section class="lg:w-[30%]">
                <div
                    v-if="lastOrder"
                    class="bg-white rounded-xl shadow shadow-zinc-200 px-4 py-6"
                >
                    <header class="flex justify-between items-start">
                        <div>
                            ...
                            <span class="text-xs text-zinc-500 block">{{
                                $date(lastOrder.created_at).format(
                                    "YYYY-MM-DD HH:mm"
                                )
                            }}</span>
                        </div>
                        ...
                        <span
                            class="px-3 py-0.5 text-xs rounded-full bg-c-green-100 text-c-green-600"
                    ...
                    >
                        ...
                        <div class="w-full">
                            <span
                                class="block text-sm font-medium leading-tight mb-1"
                                >{{ product.name }}</span
                            >
                            <span class="text-xs text-zinc-500 mr-2"
                    ...
                    <div class="flex justify-end">
                        <span
                            class="bg-zinc-100 p-2 max-w-max rounded block font-medium text-sm"
                            >${{ lastOrder.total }}</span
                        >
                    </div>
                </div>
                <div v-else>
                    ...
                    >
                        ...
                        >
                        <span class="text-xs text-zinc-500 block"
                            >Your last order will appear here.</span
                        >
                    </div>
                </div>
            </section>
