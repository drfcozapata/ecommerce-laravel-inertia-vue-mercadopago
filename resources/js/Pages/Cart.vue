        ...
        <div class="max-w-2xl mx-auto">
            <header class="py-6 border-b border-zinc-200">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p v-else class="text-zinc-500 text-sm">
                        Your cart is empty.
                        <Link :href="route('shop')" class="text-c-green-600"
                            >Continue shopping</Link
                        >
                    </p>

                    <form
                        @submit.prevent="emptyCart()"
                        v-if="products.length > 0"
                    >
                        <button
                            type="submit"
            ...
            <section v-if="products.length > 0">
                <table class="w-full my-5">
                    <tr class="">
                        <th
                            class="text-left font-normal uppercase text-xxs text-zinc-400 pb-6"
                        >
                            Product details
                        </th>
                        <th
                        ...
                        <th
                            class="text-left font-normal uppercase text-xxs text-zinc-400 pb-6 hidden sm:block"
                        >
                            Total
                        </th>
                    </tr>
                    ...
                    <tr v-for="product in products" :key="product.id">
                        ...
                        <td class="text-sm align-top">
                            <div
                                class="flex flex-col sm:flex-row items-center sm:space-x-2 sm:space-y-0 space-y-1"
                            >
            ...
            <section v-if="savedProducts.length > 0" class="mt-10">
                <header class="mb-5">
                    ...
                    <span class="text-zinc-500 text-xs"
                        >You have {{ savedProducts.length }}
                        {{
                            savedProducts.length === 1 ? "product" : "products"
                        }}
                        saved</span
                    >
                </header>
                ...
                <transition-group name="list">
                    ...
                    >
                        ...
                        <div class="w-full">
                            <div
                                class="sm:flex sm:items-start sm:justify-between sm:mb-2 sm:space-y-0 space-y-1"
                            >
                                ...
                                <form @submit.prevent="removeItem(product.id)">
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            >Remove from saved for later</span
                                        >
                                    </button>
                                </form>
                            </div>
                            ...
                            <form
                                @submit.prevent="moveToCart(product.id)"
                                class="mb-2 mt-2 sm:mt-0"
                            >
                                <button
                                    type="submit"
